...
from diary.forms import DiarySearchForm
...
@register.inclusion_tag('diary/includes/category_links.html')
def render_category_links():
    return {
        'category_list': Category.objects.annotate(diary_count=Count('diary'))
    }

@register.inclusion_tag('diary/includes/search_form.html')
